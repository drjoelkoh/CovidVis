...
density_plot <- ggplot(covid_long, aes(x = Date, y = Rate_trans, color = Group)) +
  ...
  annotate("text",
           ...
           y = 5,
           label = "Dormitories cleared by Aug 2020:\nMass outbreaks ended; most\nworkers recovered or isolated. Strict\nreturn-to-work protocols and regular\nsurveillance testing causes drop\nin dormitory case rates.",
           hjust = 0, size = 2.8, color = "darkgreen") +
  annotate("text",
           x = as.Date("2021-9-27") + 5,
           y = 8.2,
           label = "Tighter restrictions:\nGroup sizes cut to 2,\nWFH default,\nschools on HBL,\nreduced dine-in/event\nsizes & strong protection\nfor vulnerable groups\ncauses drop in cases",
           hjust = 0, size = 2.8, color = "darkgreen") +
